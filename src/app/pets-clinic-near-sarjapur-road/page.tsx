...
import PetClinicsNearSarjapurContent from "@/components/PetClinicsCities/PetClinicsNearSarjapur/PetClinicsNearSarjapurContent";
...
export default function PetClinicsNearSarjapur() {
  return (
