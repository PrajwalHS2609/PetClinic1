...
import PetClinicsNearFrazerContent from "@/components/PetClinicsCities/PetClinicsNearFrazer/PetClinicsNearFrazerContent";
...
export const metadata = {
  title:
    "Best Pets Clinic near Frazer Town | Dog & Cats Clinic near Frazer Town",
  description:
    "Best Pets Clinic near Frazer Town is essential for every pet parent who wants to ensure their furry companions receive the best healthcare. ",
  canonical: "https://petclinics.co.in/best-pets-clinic-near-frazer-town",
  keywords: [
    "Pet clinic, Veterinary clinic, Dog clinic, Cat clinic",
    "Pet clinic in Bangalore, Best pet clinic in Bangalore, Bangalore",
  ],
};
export default function FrazerTownLayoutPage() {
  return (
