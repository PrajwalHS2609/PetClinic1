...
import PetClinicsNearJpNagarContent from "@/components/PetClinicsCities/PetClinicsNearJpNagar/PetClinicsNearJpNagarContent";
...
export const metadata = {
  title: "Pets Clinic near JP Nagar | Dog & Cats Clinic near JP Nagar",
  description:
    "Pets Clinic near JP Nagar is essential for every pet parent who wants to ensure their furry companions receive the best healthcare. ",
  canonical: "https://petclinics.co.in/pets-clinic-near-jp-nagar",
  keywords: [
