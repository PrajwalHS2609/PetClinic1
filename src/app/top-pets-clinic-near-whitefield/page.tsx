...
import PetClinicsNearWhitefieldContent from "@/components/PetClinicsCities/PetClinicsNearWhitefield/PetClinicsNearWhitefieldContent";
...
export const metadata = {
  title: "Top Pets Clinic near Whitefield| Dog & Cats Clinic near Whitefield",
  description:
    "Best Pets Clinic near Whitefield is essential for every pet parent who wants to ensure their furry companions receive the best healthcare.",
  canonical: "https://petclinics.co.in/top-pets-clinic-near-whitefield",
  keywords: [
    "Pet clinic, Veterinary clinic, Dog clinic, Cat clinic",
    "Pet clinic in Bangalore, Best pet clinic in Bangalore, Bangalore",
  ],
};
export default function PetClinicsNearWhitefield() {
  return (
    <div className="main-container">
      ...
      <HomeTestimonial />
      <HomePartners />
      <PetClinicsNearWhitefieldContent/>
    </div>
  );
}
