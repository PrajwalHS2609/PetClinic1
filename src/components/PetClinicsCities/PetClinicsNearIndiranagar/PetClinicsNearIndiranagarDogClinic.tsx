...
export default function PetClinicsNearIndiranagarDogClinic() {
  return (
    <div className="contentList-container">
      <h4>Finding a Reliable Dogs Clinic near Indiranagar</h4>
      <p>
        If you are a dog owner, finding a specialized{" "}
        <a href="https://petclinics.co.in/pets-training-in-bangalore">
          dogs clinic near Indiranagar{" "}
        </a>
